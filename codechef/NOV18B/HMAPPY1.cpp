...
int main() {
	...
	if (secondMAX != INT_MIN) {
		possibleSolutions.push_back(
			make_pair(secondMAX, make_pair(secondMAX_i, secondMAX_j)));
	}
	...
	if (isCornerRequired) {
		possibleSolutions.push_back(
			make_pair(cornerCount, make_pair(corner_i, corner_j)));
	}


	sort(possibleSolutions.begin(), possibleSolutions.end(),
		 [](piii a, piii b) { return a.second.first < b.second.first; });
